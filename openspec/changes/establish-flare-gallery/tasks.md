...
- [x] 9.10 HoverPreview sits beside the hovered ChapterNav row (`--z-hover`). Clamp only to site nav / viewport — never the chapter `.bar`. No Replay button. Native OS cursor (do not hide the system pointer).
