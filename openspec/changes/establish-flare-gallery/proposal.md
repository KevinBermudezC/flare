...
- Site chrome: SiteShell frame, TypeCharge inset on home, vertical chapter index (01-06), swap-friendly nav mark, minimal footer, `/chapters/[slug]` with one live mount plus copy and edit
